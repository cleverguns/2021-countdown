...
/* add this code if you want to customize:

let current = new Date('2020-12-31 17:00:58').getTime();

*/

let current = new Date().getTime(); //sinet ko lang yung pc ko sa 11:59 pm Test lang
